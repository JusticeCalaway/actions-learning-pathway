...
This repository contains the core web application files and configuration you'll need to follow along through the [Building an application with GitHub Actions](https://resources.github.com/learn/pathways/automation/essentials/how-to-make-an-application-with-github-actions/?utm_campaign=2024Q2-Learning-Pathways&utm_medium=product&utm_source=github) module.
